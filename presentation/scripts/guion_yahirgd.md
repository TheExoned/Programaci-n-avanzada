...
## Guion de Yahir Gonzalez Dominguez - Seguimiento CQC (BLE) y Memoria No Vólatil :
...
borrado térmico ( nvs_flash_erase )en el arranque si detectábamos firmas corruptas. 
Aprendi que la gestión de memoria en sistemas embebidos no perdona errores de punteros
